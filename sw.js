const CACHE_NAME = 'smart-tools-v4';
const ASSETS = [
  '/smartsn/',
  '/smartsn/index.html',
  '/smartsn/hub.html',
  '/smartsn/consultants.json',
  '/smartsn/manifest.json',
  '/smartsn/images/logo.png',
  '/smartsn/wp_orange.html',
  '/smartsn/wp_eneco.html',
  '/smartsn/wp_rem.html',
  '/smartsn/documents/wp_orange.pdf',
  '/smartsn/documents/wp_eneco.pdf',
  '/smartsn/documents/wp_smartPlan.pdf',
